...
The objective of this week's tutorial is to familiarize yourself with the tools and techniques to do exploratory analyses for time series analysis and fit an autoregressive integrated moving average model (ARIMA).
...
![ARIMA Flow Chart](img/ts002.jpg)
