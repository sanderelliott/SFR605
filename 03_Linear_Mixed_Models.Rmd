...
M1 <- lmer(Z_TP ~ Z_Length + (1 | Lake) + (1 | Fish_Species),
     data = fish.data, REML = TRUE)# Full model with varying intercepts #Hint: you already defined this above
M2 <- lmer(Z_TP ~ Z_Length + (1 | Lake:Fish_Species),
     data = fish.data, REML = TRUE)# Full model with varying intercepts and slopes #Hint: you already defined this above
