...
\pandocbounded{\includegraphics[keepaspectratio]{03_Linear_Mixed_Models_ADD_ON_files/figure-latex/unnamed-chunk-2-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03_Linear_Mixed_Models_ADD_ON_files/figure-latex/unnamed-chunk-2-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03_Linear_Mixed_Models_ADD_ON_files/figure-latex/unnamed-chunk-2-3.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03_Linear_Mixed_Models_ADD_ON_files/figure-latex/unnamed-chunk-3-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03_Linear_Mixed_Models_ADD_ON_files/figure-latex/unnamed-chunk-3-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03_Linear_Mixed_Models_ADD_ON_files/figure-latex/unnamed-chunk-8-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03_Linear_Mixed_Models_ADD_ON_files/figure-latex/unnamed-chunk-8-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03_Linear_Mixed_Models_ADD_ON_files/figure-latex/unnamed-chunk-8-3.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03_Linear_Mixed_Models_ADD_ON_files/figure-latex/unnamed-chunk-10-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03_Linear_Mixed_Models_ADD_ON_files/figure-latex/unnamed-chunk-11-1.pdf}}
...
\section{Extension for Week - day -
Assignment}\label{extension-for-week---day---assignment}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fav }\OtherTok{\textless{}{-}} \FunctionTok{lmer}\NormalTok{(Z\_TP }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Z\_Length }\SpecialCharTok{+}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{+}\NormalTok{ Z\_Length }\SpecialCharTok{|}\NormalTok{ Fish\_Species) }\SpecialCharTok{+}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{|}\NormalTok{ Lake),}
           \AttributeTok{data =}\NormalTok{ fish.data, }\AttributeTok{REML =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
##   31.1959   53.5466   -8.5979   17.1959       173 
## Random effects:
##  Groups       Name        Std.Dev. Corr
##  Lake         (Intercept) 0.4217       
##  Fish_Species (Intercept) 0.7650       
##               Z_Length    0.1274   1.00
##  Residual                 0.2243       
## Number of obs: 180, groups:  Lake, 6; Fish_Species, 3
## Fixed Effects:
## (Intercept)     Z_Length  
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fam\_reml }\OtherTok{\textless{}{-}} \FunctionTok{lmer}\NormalTok{(Z\_TP }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Z\_Length }\SpecialCharTok{+}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{+}\NormalTok{ Z\_Length }\SpecialCharTok{|}\NormalTok{ Fish\_Species) }\SpecialCharTok{+}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{|}\NormalTok{ Lake),}
           \AttributeTok{data =}\NormalTok{ fish.data, }\AttributeTok{REML =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
## Formula: Z_TP ~ Z_Length + (1 + Z_Length | Fish_Species) + (1 | Lake)
##    Data: fish.data
## REML criterion at convergence: 21.6802
## Random effects:
##  Groups       Name        Std.Dev. Corr
##  Lake         (Intercept) 0.4528       
##  Fish_Species (Intercept) 0.9312       
##               Z_Length    0.1570   1.00
##  Residual                 0.2245       
## Number of obs: 180, groups:  Lake, 6; Fish_Species, 3
## Fixed Effects:
## (Intercept)     Z_Length  
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fav\_pql }\OtherTok{\textless{}{-}} \FunctionTok{glmmPQL}\NormalTok{(}
  \AttributeTok{fixed =}\NormalTok{ Z\_TP }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Z\_Length,}
  \AttributeTok{random =} \FunctionTok{list}\NormalTok{(}
    \AttributeTok{Lake =} \SpecialCharTok{\textasciitilde{}} \DecValTok{1}\NormalTok{,}
    \AttributeTok{Fish\_Species =} \SpecialCharTok{\textasciitilde{}}\NormalTok{ Z\_Length}
\NormalTok{  ),}
  \AttributeTok{family =}\NormalTok{ gaussian,}
  \AttributeTok{data =}\NormalTok{ fish.data)}
\end{Highlighting}
\end{Shaded}
...
## StdDev:    0.439206
## 
##  Formula: ~Z_Length | Fish_Species %in% Lake
##  Structure: General positive-definite, Log-Cholesky parametrization
##             StdDev    Corr  
## (Intercept) 0.8042587 (Intr)
## Z_Length    0.1383724 0.917 
## Residual    0.2193691       
## 
## Variance function:
...
## Number of Groups: 
##                   Lake Fish_Species %in% Lake 
##                      6                     18
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{AICfav  }\OtherTok{\textless{}{-}}\NormalTok{ MuMIn}\SpecialCharTok{::}\FunctionTok{model.sel}\NormalTok{(fav, fam\_reml, fav\_pql)}
\NormalTok{AICfav}
\end{Highlighting}
\end{Shaded}
...
##               (Int)  Z_Lng   class REML           random df  logLik AICc delta
## fav      -0.0008947 0.4222 lmerMod    F    1+Z_Ln|F_S+Lk  7  -8.598 31.8  0.00
## fam_reml -0.0009059 0.4223 lmerMod    T    1+Z_Ln|F_S+Lk  7 -10.840 36.3  4.48
## fav_pql  -0.0010550 0.4236 glmmPQL      Lk+Z_Ln|F_S%i%Lk  7                   
## Abbreviations:
##  REML: F = 'FALSE', T = 'TRUE'
## Models ranked by AICc(x) 
## Random terms: 
##  1+Z_Ln|F_S   : 1 + Z_Length | Fish_Species
##  Lk           : 1 | Lake
##  Z_Ln|F_S%i%Lk: Z_Length | Fish_Species %in% Lake
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{r.squaredGLMM}\NormalTok{(fav) }
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##            R2m       R2c
## [1,] 0.1769027 0.9500762
\end{verbatim}

\begin{enumerate}
\def\labelenumi{\arabic{enumi})}
\item
  The PQL does not have any comparative statistics. The maximum
  likelihood model had a smaller AIC value than the REML and is likely
  the stronger of the two.
\item
  The marginal R2 is much lower than the conditional, so the random
  effects, species and length, acount for much more of the variation
  than the fixed effect of length.
\end{enumerate}
